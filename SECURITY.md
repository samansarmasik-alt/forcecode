...
Security fixes are provided for the latest released version of ForceCode. Older versions should be upgraded before a report is investigated.
...
- the ForceCode version and Python/Windows versions;
